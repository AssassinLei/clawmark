...
export const photosApi = {
  ...
  create(coupleId, payload) {
    return request(`/couples/${coupleId}/photos`, 'POST', payload)
  },

  batchCreate(coupleId, payload) {
    return request(`/couples/${coupleId}/photos/batch`, 'POST', payload)
  },

  delete(coupleId, photoId) {
    return request(`/couples/${coupleId}/photos/${photoId}`, 'DELETE')
  }
}
